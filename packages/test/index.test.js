...
//       }
//     );
//     console.log("response ois " + response + "avatar id " + avatarId);
...
//     console.log(
//       response.data.avatars + " length is " + response.data.avatars.length
//     );
...
//       }
//     );
//     console.log("delete space route" + JSON.stringify(response.data));
...
//       }
//     );
//     console.log("without map id wla" + response.data);
...
//       }
//     );
//     console.log("after that delete krne wla" + deleteReponse.data);
...
//     });
//     expect(response.status).toBe(400);
//     console.log("final wala ka log" + response.data);
//   });
...
//       }
//     );
//     console.log("last api test" + response.data);
...
describe("Websocket tests", () => {
  ...
  test("Get back ack for joining the space", async () => {
    ...
    console.log("message for test 1 is " + message1);
    ...
    console.log("admin cordinates are " + adminX + adminY);
  ...
  test("User should not be able to move across the boundary of the wall", async () => {
    ...
    console.log("comming from rejected " + JSON.stringify(message));
